...
_sage_const_20 = Integer(20); _sage_const_0 = Integer(0); _sage_const_8 = Integer(8); _sage_const_1 = Integer(1); _sage_const_43 = Integer(43); _sage_const_97 = Integer(97); _sage_const_157 = Integer(157); _sage_const_14 = Integer(14); _sage_const_57 = Integer(57); _sage_const_2 = Integer(2); _sage_const_13 = Integer(13); _sage_const_5 = Integer(5)
...
def smart_attack(P, Q, p):
    ...
    for attempt in range(_sage_const_20 ):
        ainvs = E.a_invariants()
        lifted = [
            ZZ(t) + ZZ.random_element(_sage_const_0 , p) * p
            for t in ainvs
        ]
