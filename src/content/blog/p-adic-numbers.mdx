...
The tree below shows how the 5-adic distance organizes the integers 0 through
24\. Numbers sharing the same residue mod 5 are grouped in the same branch;
numbers in the same branch are closer (distance at most $1/5$) than numbers in
different branches (distance 1). Click two leaves to compute their 5-adic
distance.
