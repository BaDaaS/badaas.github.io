...
$|a-c|_p$. Suppose $|a-b|_p > |b-c|_p$. Since $a-c = (a-b) + (b-c)$, the
ultrametric inequality gives $|a-c|_p \leq \max(|a-b|_p, |b-c|_p) = |a-b|_p$.
For the reverse direction, $a-b = (a-c) + (c-b)$, so
